...
const BookDetails = () => {
  ...
  return (
    <div className='my-container'>
      <div>
        <div className='flex flex-col max-w-screen-lg overflow-hidden bg-white border rounded shadow-sm lg:flex-row'>
          <div className='lg:w-1/2 h-full'>
            <img src={image} alt="book cover" className='object-cover w-full lg:h-full' />
          </div>
          {/* Details container */}
          <div className='p-8 bg-white lg:p-16 lg:pl-16 lg:w-1/2'>
            <div>
          ...
          <div className='flex gap-5 items-center mt-5'>
            <a href={url} target="-blank" className='btn'>
              Buy Now</a>
